...
-- if you load infinite yeild after you executed any script with LinoriaLib it will just break the whole UI lib :/ (thats why I added getgenv().Linoria)
...
CursorImage.Image = 'rbxassetid://' .. tostring(Library.Cursor.Image)
...
RunService:BindToRenderStep('LinoriaCursor', Enum.RenderPriority.Input.Value, function()
    ...
    CursorImage.ImageColor3 = Library.Scheme.AccentColor
    CursorImage.Size = Library.Cursor.Size
    CursorImage.Visible = Library.ShowCustomCursor and Library.Toggled

    if CursorImage.Image ~= 'rbxassetid://' .. Library.Cursor.Image then
        CursorImage.Image = 'rbxassetid://' .. Library.Cursor.Image
    end
end)
...
function Library:AddToolTip(InfoStr, DisabledInfoStr, HoverInstance)
    ...
    local function UpdateText(Text)
        ...
        local X, Y = Library:GetTextBounds(Text, Library.Scheme.Font, 14 * DPIScale)
        Label.Text = Text
...
Library.Scheme.AccentColorDark = Library:GetDarkerColor(Library.Scheme.AccentColor)
    ...
    function BaseAddonsFuncs:AddKeyPicker(Idx, Info)
        ...
        do
            ...
            function KeybindsToggle:Display(State)
                KeybindsToggleInner.BackgroundColor3 = State and Library.Scheme.AccentColor or Library.Scheme.MainColor
                KeybindsToggleInner.BorderColor3 = State and Library.Scheme.AccentColorDark or Library.Scheme.OutlineColor
                KeybindsToggleLabel.TextColor3 = State and Library.Scheme.AccentColor or Library.Scheme.FontColor
...
function BaseAddonsFuncs:AddDropdown(Idx, Info)
        ...
        function Dropdown:UpdateColors()
            if Dropdown.Disabled then
                ...
                DropdownInner.BackgroundColor3 = Library.Scheme.MainColor
                DropdownInner.BorderColor3 = Library.Scheme.DisabledOutlineColor
                ItemList.TextColor3 = Library.Scheme.DisabledTextColor
                DropdownArrow.ImageColor3 = Library.Scheme.DisabledTextColor
            else
                ...
                DropdownInner.BackgroundColor3 = Library.Scheme.MainColor
                DropdownInner.BorderColor3 = Library.Scheme.OutlineColor
                ItemList.TextColor3 = Library.Scheme.FontColor
                DropdownArrow.ImageColor3 = Library.Scheme.FontColor
            end
        end
        ...
        function Dropdown:Display()
            ...
            local X = ListOuter.Visible and OpenedXSizeForList or Library:GetTextBounds(ItemList.Text, Library.Scheme.Font, ItemList.TextSize, Vector2.new(ToggleLabel.AbsoluteSize.X, math.huge)) + 26
        ...
        function Dropdown:BuildDropdownList()
            ...
            for Idx, Value in next, Values do
                ...
                function Table:UpdateButton()
                    ...
                    ButtonLabel.TextColor3 = Selected and Library.Scheme.AccentColor or (IsDisabled and Library.Scheme.DisabledAccentColor or Library.Scheme.FontColor)
                ...
                local X = Library:GetTextBounds(Str, Library.Scheme.Font, ItemList.TextSize, Vector2.new(ToggleLabel.AbsoluteSize.X, math.huge)) + 26
...
function BaseGroupboxFuncs:AddLabel(...)
    ...
    if Data.DoesWrap then    
        local Y = select(2, Library:GetTextBounds(Data.Text, Library.Scheme.Font, 14 * DPIScale, Vector2.new(TextLabel.AbsoluteSize.X, math.huge)))    
    ...
    function Label:SetText(Text)    
        TextLabel.Text = Text    
        if Data.DoesWrap then    
            local Y = select(2, Library:GetTextBounds(Text, Library.Scheme.Font, 14 * DPIScale, Vector2.new(TextLabel.AbsoluteSize.X, math.huge)))    
            TextLabel.Size = UDim2.new(1, -4, 0, Y)    
        end    
        Groupbox:Resize()    
    end    
    ...
    local function CreateBaseButton(Button)
        ...
        Outer.MouseEnter:Connect(function()
            ...
            Outer.BorderColor3 = Library.Scheme.AccentColor
            Groupbox.HighlightedButton = Outer
        end)

        Outer.MouseLeave:Connect(function()
            Outer.BorderColor3 = Button.Disabled and Library.Scheme.OutlineColor or Color3.new(0, 0, 0)
    ...
    local function InitEvents(Button)
        ...
        Button.Outer.InputBegan:Connect(function(Input)
            ...
            if Button.DoubleClick then
                ...
                Button.Label.TextColor3 = Library.Scheme.FontColor
    ...
    function SubButton:UpdateColors()
        SubButton.Label.TextColor3 = SubButton.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor
        SubButton.Inner.BackgroundColor3 = SubButton.Disabled and Library.Scheme.MainColor or Library.Scheme.MainColor
        SubButton.Inner.BorderColor3 = SubButton.Disabled and Library.Scheme.DisabledOutlineColor or Library.Scheme.OutlineColor
        local defaultBorder = SubButton.Disabled and Library.Scheme.OutlineColor or Color3.new(0, 0, 0)
        SubButton.Outer.BorderColor3 = (not SubButton.Disabled and SubButton.Groupbox.HighlightedButton == SubButton.Outer) and Library.Scheme.AccentColor or defaultBorder
    end
...
function Button:UpdateColors()
    Button.Label.TextColor3 = Button.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor
    Button.Inner.BackgroundColor3 = Button.Disabled and Library.Scheme.MainColor or Library.Scheme.MainColor
    Button.Inner.BorderColor3 = Button.Disabled and Library.Scheme.DisabledOutlineColor or Library.Scheme.OutlineColor
    local defaultBorder = Button.Disabled and Library.Scheme.OutlineColor or Color3.new(0, 0, 0)
    Button.Outer.BorderColor3 = (not Button.Disabled and Button.Groupbox.HighlightedButton == Button.Outer) and Library.Scheme.AccentColor or defaultBorder
end
...
return Button
    ...
    if typeof(LabelText) ~= "string" or LabelText == '' then
        ...
        function Divider:SetText(Text: string)
            ...
            LeftLine.Size = UDim2.new(0.5, -Label.Size.X.Offset / 2 - 4, 0, 5)
            RightLine.Size = UDim2.new(0.5, -Label.Size.X.Offset / 2 - 4, 0, 5)
            RightLine.Position = UDim2.new(0.5, Label.Size.X.Offset / 2 + 4, 0.5, -0.5)          
        end
    end
    ...
    function Textbox:UpdateColors()
        Box.TextColor3 = Textbox.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor
        Library.RegistryMap[Box].Properties.TextColor3 = Textbox.Disabled and 'DisabledTextColor' or 'FontColor'

        InputLabel.TextColor3 = Textbox.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor
        Library.RegistryMap[InputLabel].Properties.TextColor3 = Textbox.Disabled and 'DisabledTextColor' or 'FontColor'

        TextBoxInner.BorderColor3 = Textbox.Disabled and Library.Scheme.DisabledOutlineColor or Library.Scheme.OutlineColor
        ...
        Box.PlaceholderColor3 = Textbox.Disabled and Library.Scheme.DisabledTextColor or Color3.fromRGB(190, 190, 190)
    end
    ...
    local function UpdateHighlight()
        ...
        local enter = TextBoxOuter.MouseEnter:Connect(function()
            if not Textbox.Disabled then
                TextBoxOuter.BorderColor3 = Library.Scheme.AccentColor
            end
        end)
    ...
    local function highlightOn()
        ToggleOuter.BorderColor3 = Library.Scheme.AccentColor
    end
    ...
    function Toggle:Display()  
        if Toggle.Disabled then  
            ToggleLabel.TextColor3 = Library.Scheme.DisabledTextColor  

            ToggleInner.BackgroundColor3 = Toggle.Value and Library.Scheme.DisabledAccentColor or Library.Scheme.MainColor  
            ToggleInner.BorderColor3 = Library.Scheme.DisabledOutlineColor  
        ...
        ToggleLabel.TextColor3 = Toggle.Risky and Library.Scheme.RiskColor or Library.Scheme.FontColor  

        ToggleInner.BackgroundColor3 = Toggle.Value and Library.Scheme.AccentColor or Library.Scheme.MainColor  
        ToggleInner.BorderColor3 = Toggle.Value and Library.Scheme.AccentColorDark or Library.Scheme.OutlineColor  
    ...
    if Toggle.Risky  then  
        ...
        ToggleLabel.TextColor3 = Library.Scheme.RiskColor  
    ...
    local Slider = {
        ...
        TargetValue = math.clamp(Info.Default, Info.Min, Info.Max),
        Min = Info.Min,
        Max = Info.Max,
        ...
        Callback = Info.Callback or function(Value) end,
        Callvalue = Info.Callvalue or "Instant",
        animConnection = nil,
        isDragging = false,
        StartValue = 0,
        StartTime = 0,
    ...
    local Fill = Library:Create('Frame', {    
        BackgroundColor3 = Library.Scheme.AccentColor,    
        BorderColor3 = Library.Scheme.AccentColorDark,    
    ...
    function Slider:UpdateColors()    
        if SliderText then    
            SliderText.TextColor3 = Slider.Disabled and Library.Scheme.DisabledAccentColor or Color3.new(1, 1, 1)    
        end    
        DisplayLabel.TextColor3 = Slider.Disabled and Library.Scheme.DisabledAccentColor or Color3.new(1, 1, 1)    

        HideBorderRight.BackgroundColor3 = Slider.Disabled and Library.Scheme.DisabledAccentColor or Library.Scheme.AccentColor    

        Fill.BackgroundColor3 = Slider.Disabled and Library.Scheme.DisabledAccentColor or Library.Scheme.AccentColor    
        Fill.BorderColor3 = Slider.Disabled and Library.Scheme.DisabledOutlineColor or Library.Scheme.AccentColorDark    
    ...
    function Slider:SetMax(Value)    
        ...
        Slider.TargetValue = math.clamp(Slider.TargetValue, Slider.Min, Slider.Max)    
        if Slider.Value ~= Slider.TargetValue then
            Slider:SetTarget(Slider.TargetValue)
        else
            Slider:Display()
        end
    end    
    ...
    function Slider:SetTarget(New)
        New = Round(math.clamp(New, Slider.Min, Slider.Max))
        if New == Slider.TargetValue then
            return
        end
        Slider.TargetValue = New
        if Slider.Callvalue == "Instant" then
            ...
            local diff = Slider.TargetValue - Slider.Value
            local absDiff = math.abs(diff)
            local range = Slider.Max - Slider.Min
            local unitDur = fullDur / range
            Slider.StartValue = Slider.Value
            Slider.StartTime = tick()
            Slider.Duration = absDiff * unitDur
            if Slider.Duration == 0 then
                Slider.Value = Slider.TargetValue
                Slider:Display()
                Library:SafeCallback(Slider.Callback, Slider.Value)
                Library:SafeCallback(Slider.Changed, Slider.Value)
            ...
            if Slider.animConnection then
                Slider.animConnection:Disconnect()
                Slider.animConnection = nil
            end
            Slider.animConnection = RenderStepped:Connect(function()
                local elapsed = tick() - Slider.StartTime
                local alpha = math.clamp(elapsed / Slider.Duration, 0, 1)
                local newValue = Round(Slider.StartValue + (Slider.TargetValue - Slider.StartValue) * alpha)
    ...
    function Dropdown:UpdateColors()
        if DropdownLabel then  
            DropdownLabel.TextColor3 = Dropdown.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor
        end  
        ItemList.TextColor3 = Dropdown.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor 
        DropdownArrow.ImageColor3 = Dropdown.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor
        DropdownInner.BackgroundColor3 = Dropdown.Disabled and Library.Scheme.MainColor or Library.Scheme.MainColor
        DropdownInner.BorderColor3 = Dropdown.Disabled and Library.Scheme.DisabledOutlineColor or Library.Scheme.OutlineColor
        if DropdownInnerSearch then
            DropdownInnerSearch.TextColor3 = Dropdown.Disabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor
        end
    end  
    ...
    function Dropdown:BuildDropdownList()  
        ...
        for Idx, Value in next, Values do  
            ...
            function Table:UpdateButton()  
                ...
                ButtonLabel.TextColor3 = Selected and Library.Scheme.AccentColor or (IsDisabled and Library.Scheme.DisabledTextColor or Library.Scheme.FontColor)  
...
do
    ...
    local Gradient = Library:Create('UIGradient', {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Library:GetDarkerColor(Library.Scheme.MainColor)),
...
function Library:SetWatermarkVisibility(Bool: boolean)
...
function Library:Notify(...)
    ...
    local XSize, YSize = Library:GetTextBounds(Data.Description, Library.Scheme.Font, 14)
    YSize = YSize + 7
    ...
    function Data:Resize()
        XSize, YSize = Library:GetTextBounds(NotifyLabel.Text, Library.Scheme.Font, 14)
        YSize = YSize + 7
...
function Window:AddTab(Name, Image)
        ...
        local TabButtonWidth = Library:GetTextBounds(Tab.Name, Library.Scheme.Font, 16) + extraWidth
        ...
        function Tab:Resize()
            if TopBar.Visible  then
                ...
                local Size = 27 + select(2, Library:GetTextBounds(TopBarTextLabel.Text, Library.Scheme.Font, 14, Vector2.new(TopBarTextLabel.AbsoluteSize.X, math.huge)))
        ...
        function Tab:UpdateWarningBox(Info)
            ...
            TopBarInner.BorderColor3 = Tab.WarningBox.IsNormal  and Library.Scheme.OutlineColor or Color3.fromRGB(0, 0, 0)
            TopBarInner.BackgroundColor3 = Tab.WarningBox.IsNormal  and Library.Scheme.BackgroundColor or Color3.fromRGB(117, 22, 17)
            TopBarHighlight.BackgroundColor3 = Tab.WarningBox.IsNormal  and Library.Scheme.AccentColor or Color3.fromRGB(255, 75, 75)
             
            TopBarLabel.TextColor3 = Tab.WarningBox.IsNormal  and Library.Scheme.FontColor or Color3.fromRGB(255, 55, 55)
            TopBarLabelStroke.Color = Tab.WarningBox.IsNormal  and Library.Scheme.Black or Color3.fromRGB(174, 3, 3)
